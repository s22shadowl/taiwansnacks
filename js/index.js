...
angular.module("snackApp",['pascalprecht.translate'])
.controller("myCtrl", myCtrl)
.filter("hasTag", function(){
    return function(list, t){
        console.log(t);
        return list.filter(function(o){
            if (t!='台灣' && o && !o.tags) return false;
            return (!t || !o || !o.tags || o.tags.indexOf(t) > -1);
        })
    }
})
;
...
function myCtrl($scope,$translate) {
   ...
   $scope.list = [
    {id:0, 'zh-TW':'總覽',
     tags: '',
     en:'Overview', ja:'概要', Tells:'本站蒐羅了部分知名的台灣小吃，並且分類，請點擊左側的"台灣小吃"按鈕進行瀏覽。本站純屬學生練習作業用途。',
     img:'http://upload.wikimedia.org/wikipedia/en/6/65/Hello_logo_sm.gif',},
    {id:1, 'zh-TW':'空心菜',
     tags: '正餐',
     en:'Water Spinach', ja:'ほうれん草', Tells:'蕹菜以嫩莖、葉炒食或作湯，為夏秋高溫季節主要菜之一。一般家庭或熱炒店炒空心菜，通常以蒜頭或鹽，醬油進行調味，偶爾加入牛肉。若以豬油炒風味更佳。而椒絲腐乳通菜在廣東、香港和澳門等地區十分流行。',
     img:'http://6point7billion.files.wordpress.com/2011/08/e7a9bae5bf83e88f9c.jpg',},
     
    {id:2, 'zh-TW':'高麗菜',
     tags: '正餐+早餐',
     en:'Cabbage',
     ja:'キャベツ',
     Tells:'捲心菜營養相當豐富，含有大量維生素C、纖維素、碳水化合物和各種礦物質。除此以外捲心菜還含有維生素U。高麗菜中含有的蘿蔔硫素，則是功能強大的抗氧化物，可以增強體內酵素的解毒能力，也是維生素C和纖維的良好來源。',
    ...
    {id:6, 'zh-TW':'菜脯蛋',
     ...
     {id:13, 'zh-TW':'蛋餅',
     tags:'早餐+宵夜',
      en: 'omelet', ja:'パンケーキ',Tells:'蛋餅是一種以蛋作食材的菜式，通常使用雞蛋，加入其他配料煎成扁平狀。',
     img:'http://link.photo.pchome.com.tw/s08/kid0406/432/134487149354/', },      {id:14, 'zh-TW':'甘蔗汁',tags:'飲品', en:'Sugar cane juice', ja:'サトウキビジュース',Tells:'甘蔗汁，簡稱蔗汁，是以甘蔗壓榨成汁的飲料，方便不想咀嚼硬甘蔗者直接喝汁食用，原汁原味，最能喝出甘甜滋味，且滋潤美容養顏。常見於台灣中南部甘蔗產區，是來台灣旅遊觀光客首選台灣冰品飲料。在香港一些果汁店也可以買到。除了鮮榨蔗汁外，還有商人推出瓶裝蔗汁，可以貯存較長時間。',
     img:'http://upload.wikimedia.org/wikipedia/commons/5/56/SugarCanejuiceglass.jpg', },
     {id:15, 'zh-TW':'酸梅汁',tags:'飲品', en:'Plum juice', ja:'クランベリージュース',Tells:'酸梅湯是中國一種傳統的消暑酸甜口味飲料，主要用烏梅、桂花、冰糖等材料製成，通常夏天冰鎮飲用，能夠清涼解暑。',
     img:'http://upload.wikimedia.org/wikipedia/commons/6/60/Sour_plum_drink.jpg', },     
     {id:16, 'zh-TW':'楊桃汁',tags:'飲品', en:'Star fruit juice', ja:'カランボラジュース',Tells:'楊桃汁所屬美食之一，主要原料有熟透楊桃一個,細砂糖適量,溫開水適量等，這道菜非常美味。',
     img:'http://www.17life.com/media/A0-02-722/08aa2018EDM4c75EDM4587EDMb644EDM43442973222e.jpg', },     
     {id:17, 'zh-TW':'青草茶',tags:'飲品', en:'Herb juice', ja:'草茶',Tells:'涼茶，也叫青草茶或百草茶，是一種在中國大陸南方（廣東、廣西、福建等地），甚至馬來西亞新加坡等亞熱帶地區，流行的一種飲料，取材自多種藥草組合而成的飲料[1]。因為廣東地處之嶺南，天氣炎熱，多雨地濕，自古多有瘴氣。因此民間流行以藥性寒涼，消暑解熱的中草藥，熬水來喝，稱為各式各樣的「涼茶」。有些帶有苦味的涼茶又稱苦茶。涼茶能流傳起來，是因為涼茶具有獨特的價值。涼茶除了有各種治病及保健的功效，還能清熱去濕，對中國大陸南方人很有幫助，所以涼茶主要於中國南方流傳。在馬來西亞華僑也慣常飲涼茶。源自上世紀四十年代，來自番禺的華僑將廣東涼茶帶到馬來西亞怡保。由於當年的怡保是「世界鍚都」，吸引許多華工漂洋過海到礦場謀生，而大多數華工都是廣東所以保留著這份飲用涼茶的習慣。慢慢涼茶在這片亞熱帶氣候的異國也流行起來。',
     img:'http://072881888.tw.tranews.com/images/Info/Y007989000001_1_1.jpg', },     
     {id:18, 'zh-TW':'蚵仔煎',tags:'正餐+宵夜', en:'Oyster omelet', ja:'オイスターオムレツ',Tells:'蚵仔煎（白話字：ô-á-chian），為一種流行於大陸的閩南地區、台灣及日本的著名小吃，係用新鮮的牡蠣、蔬菜（多用茼蒿）、雞蛋及太白粉（或番薯粉，即「地瓜粉」）芡水作成。蚵仔煎（閩南話為ô-á-chian，普通話譯作「海蠣煎」），發源於福建閩南，是福建閩南，台灣地區，廣東潮汕的經典小吃。起源是先民在無法飽食下所發明的替代糧食，是一種貧苦生活的象徵。蚵仔煎據傳就是這樣的一種在貧窮社會之下所發明的創意料理。',
     img:'http://upload.wikimedia.org/wikipedia/commons/e/ef/Billyfoodoysteromelette.jpg', },
     {id:19, 'zh-TW':'棺材板',tags:'早餐', en:'Coffin', ja:'棺板',Tells:'棺材板是一種臺灣小吃，是台南當地的特色食品。將厚片吐司炸到金黃色後撈起，中間挖空再放入雞肉、豌豆、蘿蔔和墨魚等以高湯煮成再用些牛奶勾芡，再放上吐司的蓋子即成為美味可口的棺材板。而早期尚有雞肝等素材，現在多已不再使用。',
     img:'http://upload.wikimedia.org/wikipedia/commons/7/7e/%E6%A3%BA%E6%9D%90%E6%9D%BF.jpg', },     
     {id:20, 'zh-TW':'油豆腐',tags:'正餐', en:'Oily bean curd', ja:'油揚げ',Tells:'豆卜，又稱豆腐卜、油泡、豆泡、油豆腐，是一種常見於日本、台灣和中國南方的豆製品，一般是由豆腐經過高溫油炸而成，外表屬金黃色，裡面則由於經過油炸後，水份被抽乾，因此密度呈海綿狀。豆腐卜出現的原因，是由於以前豆腐不易保存，有人在它變壞前，將一塊塊方形的板豆腐，切成小塊或切成片狀，放進油中炸成，令存放的時間增長',
     img:'http://zh.wikipedia.org/wiki/%E8%B1%86%E5%8D%9C#mediaviewer/File:HK_MK_Mongkok_Market_Bean_Curd_a.jpg', },      
          {id:21, 'zh-TW':'麻婆豆腐',tags:'正餐', en:'Spicy hot bean curd ', ja:'スパイシー豆腐',Tells:'麻婆豆腐，中國菜中的川菜的代表名作。材料主要有豆腐、牛肉碎或豬肉碎、辣椒和花椒等。麻來自花椒，辣來自辣椒，這道菜突出了川菜「麻辣」的特點。',
     img:'http://upload.wikimedia.org/wikipedia/commons/a/a5/Billyfoodmabodofu3.jpg', }, 
          {id:22, 'zh-TW':'天婦羅',tags:'正餐', en:'Tenpura ', ja:'天ぷら',Tells:'天婦羅（日語：天婦羅、天麩羅、天ぷら／てんぷら tenpura ?），又稱天麩羅，在台灣、中國大陸也稱為甜不辣。天婦羅源自葡語Tempura，是葡國人在大齋期（Lent，基督教節日，指復活節六個半星期以前）期間因禁吃肉，而以吃魚代替肉而烹煮的一種食物。拉丁文「ad tempora quadragesima」就是「守大齋期」的意思。',
     img:'http://upload.wikimedia.org/wikipedia/commons/8/8b/Tendon.jpg', },           {id:23, 'zh-TW':'蝦片',tags:'正餐+宵夜', en:'Prawn cracker', ja:'エビ片',Tells:'蝦片，又叫炸蝦片，係種用蝦同澱粉整嘅脆口零食，東南亞（尤其係印尼）比較常見。香港酒樓傳統嘅炸子雞亦會用蝦片伴碟。如果將佢整成好似薯條嘅形狀，就叫蝦條或者炸蝦條。',
     img:'http://upload.wikimedia.org/wikipedia/commons/a/ab/Fried_Krupuk_Udang.JPG', },  
          {id:24, 'zh-TW':'蝦球',tags:'正餐', en:'Shrimp balls', ja:'エビ玉',Tells:'蝦片，又叫炸蝦片，係種用蝦同澱粉整嘅脆口零食，東南亞（尤其係印尼）比較常見。香港酒樓傳統嘅炸子雞亦會用蝦片伴碟。如果將佢整成好似薯條嘅形狀，就叫蝦條或者炸蝦條。',
     img:'http://food.tank.tw/userfiles/image/SeaFood/greenstripball.jpg', },      
 {id:25, 'zh-TW':'春捲',tags:'正餐+宵夜', en:'Spring rolls', ja:'春巻き',Tells:'春卷是中國民間流行的傳統小吃，用薄麵皮，捲上餡料，經油炸的食品。各地的餡料和大小不同，但基本是扁圓筒狀。以中國為例，一般人多用蔬菜及肉作餡料，而北方部分地區則會改用紅豆沙。中國的春卷一般很小，一直徑20厘米的碟可以裝十多個。美國華人飯店做的春卷有肉餡，很大一個，一個春卷可以當一頓飯，類似於漢堡。春卷亦是滿漢全席中第二席中的一道菜式。',
     img:'http://a1.att.hudong.com/66/92/19300001309012131181928896744.jpg', }, 
 {id:26, 'zh-TW':'雞捲',tags:'正餐+宵夜', en:'Chicken rolls', ja:'チキンロール',Tells:'雞卷即多卷，原名為石碼卷，又名"燒肝"。本為中國閩南福建石碼一帶名產，後來傳至台灣後，已成為台灣著名小吃。北部地區，甚至常為祭祀時的常見主要供品。',
     img:'http://1.bp.blogspot.com/-fDJ8Q5T2Tdw/Usuic28M-1I/AAAAAAAABPs/GAEdgyS0g5Q/s1600/%E9%9B%9E%E6%8D%B2.JPG', },
 {id:27, 'zh-TW':'碗糕',tags:'早餐+正餐+宵夜', en:'Salty rice pudding', ja:'塩辛いライスプディング',Tells:'碗粿，又稱碗糕，有時被誤寫為「碗稞」，是流行於華南、粵東、臺灣等地的米食製品。因成品置於碗內，故名；分甜、鹹二類：甜碗粿是米漿經糊化後拌入糖蒸熟而成；鹹碗粿則是將糊化的米漿蒸過一次，將配料鋪於其上再蒸熟而得，並搭配醬油膏或甜辣醬食用。例如臺灣臺南市麻豆區所製作的麻豆碗粿，於國道高速公路麻豆交流道附近等販賣，因料好實在，遠近馳名。',
     img:'http://upload.wikimedia.org/wikipedia/commons/6/6f/Bowl_Rice_Cake.jpg', },
 {id:28, 'zh-TW':'筒仔米糕',tags:'正餐+宵夜', en:'Rice tube pudding', ja:'アバディーンチューブ餅',Tells:'筒仔米糕是一樣常見於台灣各地的糯米類小吃，與油飯、米糕類似，但卻是在瓷瓶、竹筒或鐵罐中炊煮而成，口味濃郁。有些店家會再淋上肉燥和加上香菜。',
     img:'http://1.bp.blogspot.com/-fDJ8Q5T2Tdw/Usuic28M-1I/AAAAAAAABPs/GAEdgyS0g5Q/s1600/%E9%9B%9E%E6%8D%B2.JPG', },          
  
  ];     
    $scope.myFood = $scope.list[0];
